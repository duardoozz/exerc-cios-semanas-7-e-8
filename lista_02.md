...
Classe Carro herda de Veiculo
  ...
  Método CalcularConsumo(km)
    Escreva("Consumo do carro: ", km / eficiencia, " litros.")
FimClasse
...
Classe Moto herda de Veiculo
  ...
  Método CalcularConsumo(km)
    Escreva("Consumo da moto: ", km / eficiencia, " litros.")
FimClasse


Início
  carro <- Novo Carro("Sedan", 2020, 12)
  moto <- Novo Moto("Esportiva", 2022, 25)

  carro.CalcularConsumo(240) // Saída: 20 litros
  moto.CalcularConsumo(250)  // Saída: 10 litros
Fim
```
______

**9)** Você é um cientista da NASA e está ajudando no desenvolvimento de um sistema de pouso para sondas espaciais em Marte. 
Seu objetivo é calcular o tempo necessário para que a sonda reduza sua velocidade até um nível seguro para pouso, 
considerando uma velocidade inicial de entrada na atmosfera marciana e uma taxa de desaceleração constante causada pelo atrito atmosférico e retrofoguetes.
...
```
Algoritmo SimularPousoSonda
  Var velocidadeInicial, velocidadeSegura, vekocidadeMinima, desaceleracao, tempoMaximo, tempo : real
  ...
  Início
    ...
    Se velocidadeSegura >= velocidadeInicial Então
      Escreva("Erro: A velocidade segura deve ser menor que a velocidade inicial.")
      Pare
    Fim-Se
    ...
    // Verifica as condições de segurança
    Se tempo > tempoMaximo Então
      Escreva("Aviso: Tempo excede o limite máximo permitido. Ajuste a desaceleração ou a velocidade inicial.")
    Senão
      Escreva("Tempo necessário para atingir a velocidade segura: ", tempo, " segundos.")
    Fim-Se
...
Função multiplicarMatrizesInvestimento(matrizA, matrizB):  
    ...
    Senão:
        ...
        matrizResultado <- novaMatriz(linhas_A, colunas_B, 0)

        #Loop para multiplicação
        Para i de 0 até linhas_A - 1 faça:
        Para j de 0 até colunas_B - 1 faça:
            Para k de 0 até colunas_A - 1 faça:
...
# Exemplo de uso da função
investimentosAno1 <- [[1000, 2000], [1500, 2500]]
fatoresCrescimento <- [[1.1, 0.9], [0.8, 1.2]]  # Exemplo de fatores de impacto financeiro

resultado <- MultiplicarMatrizesInvestimento(investimentosAno1, fatoresCrescimento)
Escrever("Resultado da multiplicação das matrizes de investimento:")
Para cada linha em resultado faça:
    Escrever(linha)
